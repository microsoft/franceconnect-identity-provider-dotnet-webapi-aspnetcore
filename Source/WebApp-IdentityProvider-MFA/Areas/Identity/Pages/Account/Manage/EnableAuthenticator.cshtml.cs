...
namespace WebApp_IdentityProvider_MFA.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(7, ErrorMessage = "Le {0} doit être entre {2} et {1} caractères de long.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Votre application d'authentification a été validée.";
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("FC Identity Provider Sample"), // TODO Replace with your own site name
